...
<head>
    ...
    <title>Менеджер - Изменение заказов</title>
...
// Сообщение о возможности изменения заказов
echo "<p>Сейчас вы можете изменять заказы</p>";

echo '<a class="button" href="customer_manager.php">Создавать</a>';
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    echo '<a class="client-link" href="client_info_update2.php?id='.$row['id_client'].'">'.htmlspecialchars($row['fn_client']).'</a>';
}
